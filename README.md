...
4) Для входа за созданного пользователя POST Запрос с телом LogInDTO
5) Пользователю с низким уровнем прав(USER) недоступны эндпоинты чувствительных операций, сервер возвращает 403/401
